...
// Unreal Y = FEMFX X
// Unreal Z = FEMFX Y
static inline FVector ConvertFEMFXVectorToUnreal(const AMD::FmVector3& vec)
{
	return FVector(-vec.z, vec.x, vec.y);
}
...
static inline void ConvertFEMFXTetRotationToUnreal(FVector& ResultCol0, FVector& ResultCol1, FVector& ResultCol2, const AMD::FmMatrix3& vec)
{
