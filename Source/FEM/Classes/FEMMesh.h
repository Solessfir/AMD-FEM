...
public:
	...
	FORCEINLINE TArray<FVector>                          GetVertexPositions()           const { return FEMMeshVertexPositions; }
...
private:
	...
	UPROPERTY()
	TArray<FVector> FEMMeshVertexPositions;
	UPROPERTY()
...
public:
	...
	*/
	FFEMFXMeshSection* CreateMeshSection(int32 SectionIndex, const TArray<FVector>& Vertices, const TArray<int32>& Triangles, const TArray<FVector>& Normals, const TArray<FVector2D>& UV0, const TArray<FColor>& VertexColors, const TArray<FFEMFXMeshTangent>& Tangents,
	...
	*	@param	bCreateCollision	Indicates whether collision should be created for this section. This adds significant cost.
	*/
	FFEMFXMeshSection* CreateMeshSection_LinearColor(int32 SectionIndex, const TArray<FVector>& Vertices, const TArray<int32>& Triangles, const TArray<FVector>& Normals, const TArray<FVector2D>& UV0, const TArray<FLinearColor>& VertexColors, const TArray<FFEMFXMeshTangent>& Tangents,
		const TArray<int>& BarycentricPosOffsetIds, const TArray<int>& BarycentricPosBaseIds, const TArray<int>& BarycentricPosOffsets, const TArray<FFEMFXMeshBarycentricPos>& BarycentricPositions, bool bCreateCollision, int32 MaxTriIndices = 0);
